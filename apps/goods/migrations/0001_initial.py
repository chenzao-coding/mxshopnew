    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_front_image', models.ImageField(blank=True, max_length=300, null=True, upload_to='goods/images/', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.TextField(default='', help_text='类别描述', max_length=300, verbose_name='类别描述')),
                ...
                ('parent_category', models.ForeignKey(blank=True, help_text='父类目', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父类目')),
            ],
            options={
                'verbose_name': '商品类别',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('index', models.IntegerField(default=0, help_text='排序', verbose_name='排序')),
                ('image', models.ImageField(blank=True, max_length=300, null=True, upload_to='goods/images/', verbose_name='图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(help_text='品牌图片', max_length=200, upload_to='brands/', verbose_name='品牌图片')),
                ('category', models.ForeignKey(blank=True, help_text='商品类目', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='brands', to='goods.GoodsCategory', verbose_name='商品类目')),
            ],
            options={
                'verbose_name': '宣传品牌',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('index', models.IntegerField(default=0, help_text='排序', verbose_name='排序')),
                ('image', models.ImageField(blank=True, max_length=300, null=True, upload_to='banner/', verbose_name='图片')),
